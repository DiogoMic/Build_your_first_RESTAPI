...
#create a database
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///diogo.db'
db = SQLAlchemy(app)
...
#https://www.diogomic.me/
#create routes
@app.route("/")
def home():
    return jsonify({"message": "Welcome to my API!"})

#https://www.diogomic.me/destination
@app.route("/destination", methods=["GET"])
def get_destinations():
    destination = Destination.query.all()
    return jsonify([destination.to_dict() for destination in destination])

#https://www.diogomic.me/destination/2
